...
public class AluguelRepositoryImpl
		implements com.ifma.aluguel.repository.AluguelRepository {
	...
	public Aluguel getById(Integer id_aluguel) {
		List<Aluguel> listaRetorno = manager
				.createQuery(
						"from Aluguel a where a.id_aluguel = :id_aluguel",
						Aluguel.class)
	...
	public List<Aluguel> getAlugueisDisponiveis(Aluguel aluguelBase) {
		...
		return manager
				.createQuery(jsql, Aluguel.class)
